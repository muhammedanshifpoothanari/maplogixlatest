...
export function Footer() {
  return (
    <footer className="bg-[#0D1F44] text-white p-10">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        <div>
          <h2 className="text-3xl font-bold mb-4">MaplogiX</h2>
          <p className="mb-6">
            Book trucks, trailers, containers from thousands of trusted transport businesses and lorry owners all across
            India.
          </p>
      ...
      <div className="mt-8 flex justify-between items-center">
        <p className="text-sm">© 2023 MaplogiX. All rights reserved.</p>
        <div className="flex space-x-4">
          ...
          <Button className="rounded-full bg-white text-blue-600 p-3 shadow-lg">
